...
| ID | Plataforma | Requisito | Cenario | Tipo | Prioridade | Automavel | Status |
|---|---|---|---|---|---|---|---|
| WEB-001 | Web | Login | Login com usuario valido | E2E | Alta | Sim | Planejado |
| WEB-002 | Web | Login | Login com senha invalida | E2E | Alta | Sim | Planejado |
| WEB-003 | Web | Carrinho | Adicionar produto ao carrinho | E2E | Alta | Sim | Planejado |
| WEB-004 | Web | Carrinho | Remover produto do carrinho | E2E | Media | Sim | Planejado |
| WEB-005 | Web | Checkout | Finalizar compra com dados validos | E2E | Alta | Sim | Planejado |
| API-001 | API | Users | Listar usuarios | API | Alta | Sim | Automatizado |
| API-002 | API | Users | Validar contrato basico de usuario | API/Contrato | Alta | Sim | Automatizado |
